...
export default function PriceCalculator() {
  ...
  return (
    <div className="p-2  md:p-4 mx-auto flex flex-col justify-center md:flex-row md:gap-4 gap-4 mb-40">
      {/* Sección Costo */}
      <div className="bg-[#0c4b2d] rounded-xl px-4 py-2 shadow shadow-gray-900 ">
        <h2 className="text-lg font-bold mb-2">COSTO</h2>
        <div className="grid grid-cols-2 gap-3">
          <textarea className='col-span-2 text-xs p-2 bg-[#0f5e38] rounded'>
          ...
          {/* <input
            ...
            className="rounded p-1 text-xs col-span-2" 
          /> */}
          ...
          <label className="font-bold text-sm md:text-md">Costo unidad (ARS):</label>
          <div className="font-mono font-bold">{fmt(costFinalARS)}</div>

          <label className="font-bold text-sm md:text-md">Costo total (ARS):</label>
          <div className="font-mono font-bold">{fmt(costFinalARS*quantity)}</div>
        </div>
      </div>

      {/* Sección Venta */}
      <div className="bg-[#21387d] rounded-xl px-4 py-2 shadow md:w-1/3 shadow shadow-gray-900">
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <input
            ...
            className="bg-[#2543ab] rounded p-1"
          />
